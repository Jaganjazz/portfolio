...
export const projects: Project[] = [
  ...
  },
  {
    ...
    shortDescription:
      "Built an AI-powered travel planning application that creates personalized itineraries using user preferences, budget and duration.",
    overview:
      "TRIVIVA is an intelligent travel synthesis platform that transforms high-level user preferences, budgetary limits, and time constraints into optimal, day-by-day travel schedules and personalized activity plans.",
    problem:
      "Planning multi-day itineraries across unfamiliar destinations requires hours of cross-referencing maps, pricing, operating hours, and travel reviews, leading to decision fatigue and disjointed trips.",
    approach:
      "Engineered structured prompt workflows and generative constraint-satisfaction algorithms to iteratively build cohesive itineraries that minimize travel friction while maximizing personalized interests.",
    technologies: [
      "Python",
      "Generative AI",
      "Prompt Engineering",
    ...
    keyFeatures: [
      "Intelligent budget-aware allocation of accommodations, dining, and activities.",
      "Multi-day geographical routing optimizing transit times between attractions.",
      "Dynamic personalization adapting to preferences (cultural, adventure, leisure, culinary).",
      "Clean exportable schedule with integrated timings and localized recommendations.",
    ],
    architecture: {
      summary:
        "User Constraint Input → Semantic Preference Embeddings → LLM Contextual Reasoning & Scheduling → Spatial Route Optimization → Formatted Itinerary Render.",
      steps: [
        {
          title: "1. Preference & Constraint Gathering",
          desc: "Captures traveler profile, budget thresholds, dates, pacing, and group dynamics.",
        },
        {
          title: "2. Contextual Generative Synthesis",
          desc: "Applies prompt engineering pipelines with domain guardrails to propose curated spots.",
        },
        {
          title: "3. Geo-Spatial Clustering",
          desc: "Clusters destinations by proximity to prevent redundant inter-city transit.",
        },
        {
          title: "4. Schedule Finalization",
          desc: "Outputs an interactive, day-by-day structured itinerary.",
        },
      ],
    },
    visualBg: "from-emerald-950/40 via-teal-950/20 to-neutral-950",
    accentColor: "#34D399",
    status: "Results will be added as the project evolves.",
    githubUrl: "https://github.com/Jaganjazz",
    demoUrl: "https://github.com",
