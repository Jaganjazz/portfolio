        ...
        <div className="flex flex-col divide-y divide-white/[0.08]">
          {projects.map((project) => (
            <Link
              ...
              className="group py-12 md:py-16 block transition-colors duration-300 hover:bg-white/[0.01]"
            >
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                {/* Left Column: Number & Description */}
                <div className="lg:col-span-5 flex flex-col justify-between h-full">
                  <div>
                    {/* Project Number with micro-shift on hover */}
                    ...
                    <h3 className="text-2xl sm:text-3xl md:text-4xl font-heading font-bold text-white tracking-tight mt-4 transition-transform duration-300 group-hover:translate-x-2">
                      {project.title}
                    </h3>
                  ...
                  <div className="mt-8 pt-6 border-t border-white/[0.06]">
                    ...
                    <div className="inline-flex items-center gap-2 text-sm font-mono font-semibold text-white group-hover:text-indigo-400 transition-colors">
                ...
                <div className="lg:col-span-7">
                  <div className="relative aspect-[16/9] rounded-2xl overflow-hidden border border-white/10 bg-[#090912] shadow-2xl transition-all duration-500 group-hover:border-indigo-500/40 group-hover:shadow-[0_20px_50px_rgba(99,102,241,0.15)]">
